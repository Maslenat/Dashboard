...
const stackedLine = new Chart(ctx, {
  ...
  data: {
    labels: ChartLebels,
    datasets: [{
      label: 'My task progress in duiring week',
...
},{"chart.js/auto":3,"js-datepicker":6,"moment":8,"moment/locale/ru":7}],2:[function(require,module,exports){
/*!
 * @kurkle/color v0.3.2
